...
class student:
            ...
            while True: 
                ...
                try:
                    ...
                    if choice==1:    
                        ...
                        search_contact=self.input_contact()                     
                        found=False
                        for data in self.student_data:
    ...
    def input_contact_delete(self):
        try:
            ...
            if len(str(contact)) == 10:
                ...
                print("Invalid contact! Enter 10 digit number.")
                return self.input_contact_delete()
        except:
            print("Enter Only Number Not Character.")
            return self.input_contact_delete()       
            ...
            while True:
                try:    
                    ...
                    if choice == 1:
                        ...
                        i=0
                        delete_contact = self.input_contact_delete()
                        while i < len(self.student_data):
    ...
    def main_opration(self):
        while True:
            choice = self.main_menu()
            try:
                if choice == 1:
                    self.register_opration()
                    self.save_data_opration() 
                elif choice==2:
                    self.search_opration() 
                elif choice==3:
                    self.update_opration() 
                elif choice==4:
                    self.delete_opration() 
                elif choice == 5:
